...
* Download the EMSCRIPTEN compiler [here](https://emscripten.org/docs/getting_started/downloads.html), [Python](https://www.python.org/downloads) and [Node.js](https://nodejs.org/en/download/package-manager).
